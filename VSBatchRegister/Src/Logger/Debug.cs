...
namespace VSBatchRegister.Logger;
public class Debug
{
    ...
    /// 是否在控制台输出
    /// </summary>
    public static bool IsStreamOnConsole { get; set; }
    ...
    /// 初始化日志模块
    /// </summary>
    public static void InitLog4Net(bool onConsole = true)
    {
        IsStreamOnConsole = onConsole;
